...
class Room extends EventEmitter
{
	...
	{
		////logger.debug('################ request.method:%s  request.data:%s', request.method, JSON.stringify(request.data));
		...
		switch (request.method)
		{
			...
			case 'connectWebRtcTransport':
			{
				...
				logger.debug('--------------------------- end of connectWebRtcTransport');
