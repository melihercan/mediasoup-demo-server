...
async function createExpressApp()
{
	...
	expressApp.get(
		...
		{
			console.log('>>>>>>>>>>>>> expressApp.get: /rooms/:roomId');
	...
	expressApp.post(
		...
		{
			console.log('>>>>>>>>>>>>> expressApp.post: /rooms/:roomId/broadcasters');
	...
	expressApp.delete(
		...
		{
			console.log('>>>>>>>>>>>>> expressApp.post: /rooms/:roomId/broadcasters/:broadcasterId');
	...
	expressApp.post(
		...
		async (req, res, next) =>
		{
			console.log('>>>>>>>>>>>>> expressApp.post: /rooms/:roomId/broadcasters/:broadcasterId/transports');
	...
	expressApp.post(
		...
		async (req, res, next) =>
		{
			console.log('>>>>>>>>>>>>> expressApp.post: /rooms/:roomId/broadcasters/:broadcasterId/transports/:transportId/connect');
	...
	expressApp.post(
		...
		async (req, res, next) =>
		{
			console.log('>>>>>>>>>>>>> expressApp.post: /rooms/:roomId/broadcasters/:broadcasterId/transports/:transportId/producers');
	...
	expressApp.post(
		...
		async (req, res, next) =>
		{
			console.log('>>>>>>>>>>>>> expressApp.post: /rooms/:roomId/broadcasters/:broadcasterId/transports/:transportId/consume');
	...
	expressApp.post(
		...
		async (req, res, next) =>
		{
			console.log('>>>>>>>>>>>>> expressApp.post: /rooms/:roomId/broadcasters/:broadcasterId/transports/:transportId/consume/data');
	...
	expressApp.post(
		...
		async (req, res, next) =>
		{
			console.log('>>>>>>>>>>>>> expressApp.post: /rooms/:roomId/broadcasters/:broadcasterId/transports/:transportId/produce/data');
...
{
	logger.info('running an HTTPS server...' + config.https.listenIp + ':' + config.https.listenPort);
